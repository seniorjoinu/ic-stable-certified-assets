...
use crate::state_machine::{State, BATCH_EXPIRY_NANOS};
use crate::types::{
...
use ic_stable_memory::{stable, stable_memory_init};
...
fn preserves_state_on_stable_roundtrip() {
    ...
    state.pre_upgrade();
    let mut state = State::post_upgrade();
